...
set-option -g menu-style                    "bg=$color_gray1,fg=$color_luster"
set-option -g message-command-style         "bg=$color_luster,fg=$color_gray1"
set-option -g message-style                 "bg=$color_gray1,fg=$color_luster"
set-option -g mode-style                    "bg=$color_luster,fg=$color_gray1"
set-option -g pane-active-border-style      "fg=$color_luster"
set-option -g pane-border-lines             "heavy"
set-option -g pane-border-style             "fg=$color_luster"
set-option -g pane-border-style             "fg=$color_gray1"
set-option -g popup-border-lines            "rounded"
set-option -g status-right-style            "fg=$color_gray1"
set-option -g window-status-current-style   "fg=$color_lack"
set-option -g window-status-style           "fg=$color_gray1"
