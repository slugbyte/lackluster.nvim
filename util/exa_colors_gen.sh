...
export EXA_COLORS="$(exa_group $blue gm gv gt)"
...
# metadata
export EXA_COLORS="$EXA_COLORS:$(exa_group $gray6 in bl hd lp cc)"
...
export EXA_COLORS="$EXA_COLORS:or=$red"
